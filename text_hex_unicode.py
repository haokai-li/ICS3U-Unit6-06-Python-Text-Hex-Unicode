...
# Created on: Oct 2021
# This Program is about hex unicode


def calculated_unicode(input_string):
    # This function is about hex unicode
    answer_list = []
    dictionary = {}
    ...
    for input_word in input_string:
        if input_word in dictionary.keys():
            answer_list.append(dictionary[input_word])
...
def main():
    ...
    # input
    user_string = input("Please enter a string to be translated into hex: ")

    # call functions
    unicode_name = calculated_unicode(input_string=user_string)
